            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Content Row -->
                        <div class="row">
                            <div class="col-xl-3 col-md-6 mb-4 task-card">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Tarea 1</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Revisión de cultivos</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 mb-4 task-card">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tarea 2</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Informe de ventas</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 mb-4 task-card">
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Tarea 3</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Supervisión de empleados</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 mb-4 task-card">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Tarea 4</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Revisión de maquinaria</div>
                                    </div>
                                </div>
                            </div>
                        </div>
